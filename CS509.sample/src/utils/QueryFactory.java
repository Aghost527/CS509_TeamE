...
public class QueryFactory {
	...
	public static String getDepartingAirplanes(String airportCode, String teamName, String Date){
		return "?team" + teamName + "&action=list&list_type=departing&airport" + airportCode + "day=" + Date;
	}
	
	
	public static String getArrivingAirplanes(String airportCode, String teamName, String Date){
